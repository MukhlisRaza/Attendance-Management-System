                        ...
                        <div class="card-body box-profile">
                            ...
                            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <form class="form-horizontal" role="form" action="{{url('/update-student-image')}}" name="updatestudentDetails" id="updatestudentDetails" method="post" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-8 m-auto">
                                                        ...
                                                        <input class="form-control" type="file" name="student_avatar_image" id="student_avatar_image" accept="image/*">
                                                    </div>
                                                </div>
                                    ...
                                    <form class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input class="form-control" value="{{$studentDetails['name']}}" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName2" class="col-sm-2 col-form-label">Mobile</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" value="{{$studentDetails['mobile']}}" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" value="{{$studentDetails['email']}}" readonly="">
                                            </div>
                                        </div>
